...
export const INTRO_COPY = {
  lead:
    'In wenigen Minuten trainieren Sie, wie echte Stil-Entscheidungen funktionieren: nicht nach Trend oder Rabatt, sondern nach dem ESKYNA-Kleeblatt – Farbe, Form, Wirkung und Alltag. Fehlkäufe erkennen Sie bewusst im Style-Filter.',
  claim:
...
export const LEVEL_LEARNING = [
  {
    ...
    takeaway: 'Sie haben die Sprache des Kleeblatts verinnerlicht – die Basis für jede weitere Stil-Entscheidung.',
  },
  {
    practice: 'Unter Zeitdruck Prioritäten setzen: Was zählt zuerst – Farbe, Form, Wirkung oder Alltag?',
    takeaway: 'Stil-Klarheit wächst, wenn Sie nicht alles gleichzeitig optimieren, sondern das Richtige zuerst.',
  },
  {
    practice: 'Alle vier Bereiche gleichmäßig bedenken – nicht nur Ihre Lieblingskategorie.',
    takeaway: 'Ausgewogene Signale bedeuten: Ihr Kleiderschrank funktioniert in mehr Situationen, nicht nur in einer.',
  },
  {
    practice: 'Kaufimpulse erkennen, bevor sie zur Entscheidung werden.',
    takeaway: 'Wer Fehlkäufe filtert, spart Geld, Platz und morgens die Suche nach dem „richtigen“ Teil.',
  },
  {
    practice: 'Alles verbinden: Serien, Kombination und Klarheit unter Druck.',
    takeaway: 'Sie denken Stil in Systemen – bereit, das mit EStyle dauerhaft auf Ihre Garderobe zu übertragen.',
  },
];
...
export function buildEvaluationMessage(levelIndex, won, stats, opts = {}) {
  ...
  if (stats.clarity > 0) {
    msg += 'Ihre aktuelle Stil-Klarheit: ' + stats.clarity + '% – jeder Versuch schärft das Gefühl für das Kleeblatt.';
  } else {
