...
export const ICONS = {
  ...
  form:
    '<path fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" d="M6 8h12M8 8v11M16 8v11"/><path fill="none" stroke="currentColor" stroke-width="1.5" d="M8 12c2-2 6-2 8 0"/>',
  'form-cut':
  ...
  life:
    '<rect x="4" y="5" width="16" height="16" rx="2" fill="none" stroke="currentColor" stroke-width="1.5"/><path fill="none" stroke="currentColor" stroke-width="1.5" d="M4 10h16M9 3v4M15 3v4"/><circle cx="12" cy="15" r="1.5" fill="currentColor"/>',
  'life-hanger':
