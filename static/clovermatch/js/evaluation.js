...
export function showLevelEvaluation(won, opts = {}) {
  ...
  const diamondOk =
    game.clarity > 70 &&
    [game.counts.color, game.counts.form, game.counts.impact, game.counts.life].filter((v) => v > 0).length >= 3;
  ...
  $('endMessage').textContent = buildEvaluationMessage(game.levelIndex, won, {
