...
description: Ein Wasserfallausschnitt ist ein weich drapierter Ausschnitt, bei dem Stoff in lockeren Falten fällt. Erfahre, wie er wirkt, welche Materialien geeignet sind und worauf du bei Passform und Styling achtest.
...
keywords:
  ...
  - wasserfallausschnitt einfach erklärt
  - wasserfallausschnitt stilberatung
  - wasserfallausschnitt kombinieren
weight: 1
...
faq:
  items:
    - q: Was ist ein Wasserfallausschnitt?
      a: Ein Wasserfallausschnitt ist ein Ausschnitt, bei dem der Stoff nicht glatt am Körper anliegt, sondern in weichen, lockeren Falten nach unten fällt. Dadurch entsteht eine bewegte, fließende Halslinie.
    - q: Welche Stoffe eignen sich für einen Wasserfallausschnitt?
      a: Besonders gut funktionieren weich fallende Materialien wie Viskose, Cupro, Seide oder Satin. Feste und sehr steife Stoffe bilden meist keine ruhige Drapierung, sondern stehen stärker ab.
    - q: Wie wirkt ein Wasserfallausschnitt im Outfit?
      a: Der Ausschnitt wirkt meist weich, elegant und etwas sinnlich, ohne zwingend viel Haut zu zeigen. Die genaue Wirkung hängt von Tiefe, Stoff, Farbe und dem übrigen Styling ab.
    - q: Was trage ich zu einem Wasserfallausschnitt?
      a: Da der Ausschnitt selbst bereits Bewegung erzeugt, wirken schlichte Ketten oft stimmiger als großer Halsschmuck. Ohrringe, ein Armreif oder eine feine Tasche können den Look ergänzen, ohne die Drapierung zu überladen.
lastmod: "2026-07-09"
---

## Definition

Ein **Wasserfallausschnitt** ist ein drapierter Ausschnitt, bei dem zusätzlicher Stoff am Hals oder Dekolleté in weichen Falten nach unten fällt. Anders als ein glatt anliegender Rundhals oder [V-Ausschnitt](/glossar/v-ausschnitt/) erzeugt er keine harte Kante, sondern eine fließende, bewegte Linie.

Der Begriff beschreibt vor allem die Stoffführung. Wie ausgeprägt der Wasserfallausschnitt wirkt, entscheiden Schnitt, Stoffmenge und [Materialfall](/glossar/materialfall/).
...
Die Wirkung entsteht nicht allein durch die Ausschnittform. Auch Farbe, [Glanzgrad](/glossar/glanzgrad/), Passform und die übrige Silhouette beeinflussen, ob ein Oberteil, Kleid oder Top eher schlicht, feminin oder festlich erscheint.
...
Bei Schmuck gilt: Entscheide dich bewusst. Eine lange oder große Kette kann mit den Stofffalten konkurrieren. Häufig sind [Ohrringe](/glossar/ohrringe/), ein Ring oder ein dezentes [Accessoire](/glossar/accessoire/) die stimmigere Wahl. Wenn du eine Kette tragen möchtest, sollte sie die Drapierung nicht verdecken oder unruhig auf den Falten liegen.
...
- Unterstützt das Material die weiche [Drapierung](/glossar/drapierung/) oder wirkt es zu fest und voluminös?
...
**Besser:** Kennzeichnend sind die locker fallenden Stofffalten. Ein [Wasserfallausschnitt](/glossar/wasserfallausschnitt/) ist damit eine konkrete Form der Drapierung, nicht nur ein weicher Ausschnitt.
